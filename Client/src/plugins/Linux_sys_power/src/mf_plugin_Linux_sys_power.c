...
init_mf_plugin_Linux_sys_power(PluginManager *pm)
{
    ...
    mfp_get_data_filtered_by_value("mf_plugin_Linux_sys_power", conf_data, "on");
     ...
     */
    PluginManager_register_hook(pm, "mf_plugin_Linux_sys_power", mf_plugin_Linux_sys_power_hook);
    is_initialized = 1;
    return ret;
}
