...
*     curl -i http://localhost:3033/v1/phantom_mf/profiles/dummy
*
...
*     }
*/
router.get('/:workID', middleware.ensureAuthenticated, function(req, res, next) {
...
*
* @apiExample {curl} Example usage:
*     curl -i http://localhost:3033/v1/phantom_mf/profiles/dummy/t1
*
...
*     }
*/
router.get('/:workID/:taskID', middleware.ensureAuthenticated, function(req, res, next) {
	var client = req.app.get('elastic'),
		workflow = req.params.workID,
...
*
* @apiExample {curl} Example usage:
*     curl -i http://localhost:3033/v1/phantom_mf/profiles/dummy/t1/AVSbT0ChGMPeuCn4QYjq
*
