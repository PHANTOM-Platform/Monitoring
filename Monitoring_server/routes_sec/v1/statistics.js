...
*	curl -i 'http://localhost:3033/v1/phantom_mf/statistics/ms2?metric=CPU0:core1'
*
...
*	}
*/
router.get('/:workflowID', middleware.ensureAuthenticated, function(req, res, next) {
...
*
* @apiExample {curl} Example usage:
*	curl -i 'http://localhost:3033/v1/phantom_mf/statistics/ms2/t1?metric=metric=CPU0:core1&from=2016-05-10T17:35:57.610&to=2016-05-10T17:36:57.610'
*
* @apiSuccess {Object} workflow				 workflow-related data
* @apiSuccess {String} workflow.href			 link to the stored workflow information
* @apiSuccess {String} metric				   name of the metric for which statistics are captured
...
*	}
*/
router.get('/:workflowID/:taskID', middleware.ensureAuthenticated, function(req, res, next) {
	var workflowID = req.params.workflowID,
...
*
* @apiExample {curl} Example usage:
*	curl -i 'http://localhost:3033/v1/phantom_mf/statistics/ms2/t1/AVqkW4L57rO13ZBQKOWJ?metric=metric=CPU0:core1'
*
* @apiSuccess {Object} workflow				 workflow-related data
* @apiSuccess {String} workflow.href			 link to the stored workflow information
* @apiSuccess {String} metric				   name of the metric for which statistics are captured
...
*	}
*/
router.get('/:workflowID/:taskID/:experimentID', middleware.ensureAuthenticated, function(req, res, next) {
	var workflowID = req.params.workflowID,
	taskID = req.params.taskID,
